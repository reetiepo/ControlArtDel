...
$mail->SMTPAuth = true;
$mail->SMTPSecure = "tls";
$mail->Username = "controlartdel.contato@gmail.com"; 
$mail->Password = "cad@2018!"; 
$mail->setFrom("controlartdel.contato@gmail.com", "Site CAD", "0");
$mail->AddAddress("controlartdel.contato@gmail.com");
$mail->IsHTML(true); 
$mail->CharSet = 'utf-8'; 
